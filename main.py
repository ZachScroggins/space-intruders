...
def create_enemies(enemies):
    for i in range(40):
        ...
        if i < 30 and i >= 20:
            enemies.append(
                pygame.Rect(
                    (i - 19) * (SPACESHIP_WIDTH + 20),
                    SPACESHIP_HEIGHT * 2 + 40,
                    SPACESHIP_WIDTH,
                    SPACESHIP_HEIGHT,
                )
            )
        if i < 40 and i >= 30:
            enemies.append(
                pygame.Rect(
                    (i - 29) * (SPACESHIP_WIDTH + 20),
                    SPACESHIP_HEIGHT * 3 + 60,
                    SPACESHIP_WIDTH,
                    SPACESHIP_HEIGHT,
                )
            )
...
def main():
    player = pygame.Rect(
        WIDTH / 2 - SPACESHIP_WIDTH // 2, 650, SPACESHIP_WIDTH, SPACESHIP_HEIGHT
    )
    enemies = []
